...
--
-- Host: localhost:8889
-- Generation Time: Feb 20, 2025 at 08:14 PM
...
(12, 'Jack', 'Sparrow', 'jacksparrow@pirates.ar', 'mblfg;bs');
...
INSERT INTO `media` (`id`, `filename`, `filetype`, `project_id`) VALUES
(1, 'med-greenbud', '.jpg', 1),
(2, 'med-scroll', '.jpg', 1),
(3, 'med-pin1', '.jpg', 1),
(4, 'med-sketch', '.jpg', 1),
(5, 'med-ar', '.jpg', 1),
...
INSERT INTO `projects` (`id`, `name`, `tagline`, `description`, `image_url`, `date`, `service_id`) VALUES
(1, 'Medvsa', ' Unique earbud models and engaging interactive experiences in the palm of your hand.', 'What if your earbuds could look more unique than ever? Go beyond the traditional designs and craft an interface that’s as captivating as the earbuds themselves.', '', 'November 2024', 1),
(2, 'Kevorka', ' Bold beauty reimagined: where cunning meets seduction', 'What if your makeup could command the room like a queen on the chessboard? Have an aura of danger, and be packaged in sleek, yet confidently radiant designs. ', '', 'November 2024', 2),
(3, 'Orbitz', ' Interactive flavors and cosmic adventures in every bottle.', 'What if the long forgotten brand, Orbitz, was given an update? A brand that left consumers feeling a little weird, but in a good way this time. Bring out the nostalgia of the old drink, by combining it’s space theme with a modern redesign.', '', 'April 2024', 3);
...
(1, 'The Challenge Awaits', '', 'What if your earbuds could look more unique than ever? Go beyond the traditional designs and craft an interface that’s as captivating as the earbuds themselves.', 1, 'challenge'),
...
(27, 'Bringing Ideas to Life', 'From outdated to extraordinary, every element of Orbitz was reimagined step by step.', 'Initial sketches focused on clean, futuristic packaging that highlighted the drink’s floating orbs as a feature, not a flaw. Inspiration was drawn from celestial motifs to evoke a sense of wonder. High-fidelity designs incorporated bold typography and playful flavor names, creating a product that felt vibrant and premium.', 3, 'ideas'),
(28, 'Testing the Magic', 'Feedback helped refine the rebranding into a cohesive, compelling product.', 'Feedback from professors, family, and friends were crucial in developing the consistent direction and interesting style for Orbitz. With over 15 sketches of logo concepts,  and two different bottle versions, I eventually was able to come to a finalized version that satisfied the modern rebrand. During this process, I learned a lot about target audiences and the importance of ensuring that my message was consistently on brand. ', 3, 'testing'),
(29, 'The Destination', 'Strategic execution and cohesive design made this project a triumph.', 'This project demonstrated the power of storytelling in branding and marketing. By combining narrative elements with sleek 3D design, the campaign elevated the makeup products beyond their functional purpose, aligning them with a larger, aspirational identity. The process honed my skills in 3D modeling, animation, and cross-platform branding.', 3, 'destination'),
(30, 'Reflection on Journey', '', 'The project emphasized the importance of storytelling in Motion/UI/UX design. I learned to balance functionality with branding, ensuring every user interaction felt purposeful and engaging. The iterative process also strengthened my skills in coding and animation.', 3, 'reflection');
...
(1, 'katrina', 'Blimp2-Prewashed3-Kindred1-Lucid0-Pregame0');
